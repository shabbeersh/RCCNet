...
from keras.layers import Dense, Activation, Flatten,Conv2D,MaxPooling2D, Dropout,BatchNormalization,ZeroPadding2D,merge,Input
...
PATH = "/home/ravi/Desktop/Shabbeer/crchistophenotypes32_32"
print("PWD",PATH)
# Define data path
data_path = PATH
...
csv_logger = CSVLogger('/home/ravi/Desktop/Shabbeer/softmaxCNN_F1score_NODA.csv', append=True, separator=';')
